            ...
            <div class="flex flex-col text-center mt-10">
                <ul class="w-84 mx-auto leading-relaxed text-sm overflow-x-auto">
                    <li class="flex items-left text-left whitespace-nowrap">
                        ...
                        介護休業は<span class="font-bold">対象家族1人に対する上限</span>です。
                    </li>
                    <li class="flex items-left text-left whitespace-nowrap">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                            class="w-6 h-6 mr-3">
                    ...
                    <li class="flex items-left text-left whitespace-nowrap">
                        ...
                        <span class="font-bold">1歳に満たない子と同居し扶養する者</span>は、育児休業、特別休暇(短期育休)、パパ育休を取得できます。
                    </li>
                    <li class="flex items-left text-left whitespace-nowrap">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                            class="w-6 h-6 mr-3">
                    ...
                    <li class="flex items-left text-left whitespace-nowrap">
                        ...
                        ※は<span class="font-bold">対象者、家族の状況によって異なります</span>。詳細は総務課にお問い合わせください。
                    </li>
                </ul>
            </div>
