            ...
            <div class="col-span-4 md:col-span-5">
                <div id="scrollspy-2" class="space-y-4">
                    ...
                    <div id="report-show">
                        ...
                        <!-- report-my-index -->
                        <div id="report-my-index" class="border-b-2 border-green-800">
                            <div class="max-w-2xl px-4 py-2 bg-white rounded-lg shadow-md mx-auto my-2">
                                <div class="mt-2">
                                    <h2 class="text-md font-bold text-gray-700 hover:text-gray-600 hover:underline"
                            ...
                            <section class="text-gray-600 body-font">
                                <div class="container max-w-5xl md:px-5 py-8 md:py-16 mx-auto">
                        ...
                        <!-- report-delete -->
                        <div id="report-delete" class="border-b-2 border-green-800">
                            <div class="max-w-2xl px-4 py-2 bg-white rounded-lg shadow-md mx-auto my-2">
                                <div class="mt-2">
                                    <h2 class="text-md font-bold text-gray-700 hover:text-gray-600 hover:underline"
                                        tabindex="0">申請の取消
                        ...
                        <!-- remaining-my-index -->
                        <div id="remaining-my-index" class="border-b-2 border-green-800">
                            <div class="max-w-2xl px-4 py-2 bg-white rounded-lg shadow-md mx-auto my-2">
                                <div class="mt-2">
                                    <h2 class="text-md font-bold text-gray-700 hover:text-gray-600 hover:underline"
                                        tabindex="0">
                        ...
                        <!-- approval -->
                        <div id="approval" class="border-b-2 border-green-800">
                            ...
                            <section class="text-gray-600 body-font">
                                <div class="container w-3/4 py-8 mx-auto">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-2">
                                        <!-- 承認,閲覧 start -->
                                        <a href="#report-index"
                                            class="inline-flex items-center p-2 text-lg font-medium text-gray-600 hover:text-green-800 hover:underline hover:underline-offset-0 hover:decoration-4 hover:decoration-green-500">
                                            <span class="mr-3">
                        ...
                        <!-- report-index -->
                        <div id="report-index" class="border-b-2 border-green-800">
                            <div class="max-w-2xl px-4 py-2 bg-white rounded-lg shadow-md mx-auto my-2">
                                <div class="mt-2">
                                    <h2 class="text-md font-bold text-gray-700 hover:text-gray-600 hover:underline"
                            ...
                            <section class="text-gray-600 body-font">
                                <div class="container max-w-7xl md:px-5 py-8 md:py-16 mx-auto">
                                    <div class="flex flex-col text-center w-full mb-10">
                    ...
                    <!-- report-approval -->
                    <div id="report-approval" class="border-b-2 border-green-800">
                        <div class="max-w-2xl px-4 py-2 bg-white rounded-lg shadow-md mx-auto my-2">
                            <div class="mt-2">
                                <h2 class="text-md font-bold text-gray-700 hover:text-gray-600 hover:underline"
                                    tabindex="0">申請を承認する
                    ...
                    <div id="report-cant-approval" class="border-b-2 border-green-800">
                        <div class="max-w-2xl px-4 py-2 bg-white rounded-lg shadow-md mx-auto my-2">
                            <div class="mt-2">
                                <h2 class="text-md font-bold text-gray-700 hover:text-gray-600 hover:underline"
                    ...
                    <!-- report-cancel-check -->
                    <div id="report-cancel-check" class="border-b-2 border-green-800">
                        <div class="max-w-2xl px-4 py-2 bg-white rounded-lg shadow-md mx-auto my-2">
                            <div class="mt-2">
                                <h2 class="text-md font-bold text-gray-700 hover:text-gray-600 hover:underline"
                                    tabindex="0">取消申請の確認
                    ...
                    <!-- achievement -->
                    <div id="achievement" class="border-b-2 border-green-800">
                    ...
                    <!-- export -->
                    <div id="export" class="border-b-2 border-green-800">
                        <div class="max-w-2xl px-4 py-2 bg-white rounded-lg shadow-md mx-auto my-2">
                            <div class="mt-2">
                                <h2 class="text-md font-bold text-gray-700 hover:text-gray-600 hover:underline"
                    ...
                    <!-- admin -->
                    <div id="admin" class="border-b-2 border-green-800">
                    ...
                    <!-- remaining-update -->
                    <div id="remaining-update" class="border-b-2 border-green-800">
                    ...
                    <div id="remaining-all-update" class="border-b-2 border-green-800">
                        <div class="max-w-2xl px-4 py-2 bg-white rounded-lg shadow-md mx-auto my-2">
                            <div class="mt-2">
                                <h2 class="text-md font-bold text-gray-700 hover:text-gray-600 hover:underline"
                    ...
                    <!-- user-update -->
                    <div id="user-update" class="border-b-2 border-green-800">
                        <div id="remaining-index"
                            class="max-w-2xl px-4 py-2 bg-white rounded-lg shadow-md mx-auto my-2">
                            <div class="mt-2">
                                <h2 class="text-md font-bold text-gray-700 hover:text-gray-600 hover:underline"
                    ...
                    <!-- user-delete -->
                    <div id="user-delete" class="border-b-2 border-green-800">
                        <div id="remaining-index"
                            class="max-w-2xl px-4 py-2 bg-white rounded-lg shadow-md mx-auto my-2">
                            <div class="mt-2">
                                <h2 class="text-md font-bold text-gray-700 hover:text-gray-600 hover:underline"
                    ...
                    <!-- register -->
                    <div id="register" class="border-b-2 border-green-800">
                        <div class="max-w-2xl px-4 py-2 bg-white rounded-lg shadow-md mx-auto my-2">
                            <div class="mt-2">
                                <h2 class="text-md font-bold text-gray-700 hover:text-gray-600 hover:underline"
                    ...
                    <!-- approval-info -->
                    <div id="approval-info" class="border-b-2 border-green-800">
                        <div class="max-w-2xl px-4 py-2 bg-white rounded-lg shadow-md mx-auto my-2">
                            <div class="mt-2">
                                <h2 class="text-md font-bold text-gray-700 hover:text-gray-600 hover:underline"
                                    tabindex="0">権限</h2>
                    ...
                    <!-- approval-update -->
                    <div id="approval-update" class="border-b-2 border-green-800">
                        <div class="max-w-2xl px-4 py-2 bg-white rounded-lg shadow-md mx-auto my-2">
                            <div class="mt-2">
                                <h2 class="text-md font-bold text-gray-700 hover:text-gray-600 hover:underline"
                                    tabindex="0">権限の変更</h2>
                        ...
                        <section id="approval-index" class="text-gray-600 body-font">
                            <div class="container max-w-3xl md:px-5 py-8 md:py-16 mx-auto">
                                <div class="flex flex-col text-center w-full mb-6">
                                    ...
                                    <h2 class=" text-right">
                                        <a href="#approval-create"
                                            class="inline-flex items-center justify-center text-base mr-2 font-medium text-green-800 hover:text-green-50 p-1 rounded-full border-2 border-green-800 bg-green-100/60 hover:bg-green-800">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                fill="currentColor" class="w-6 h-6">
                                                <path fill-rule="evenodd"
                    ...
                    <!-- approval-delete -->
                    <div id="approval-delete" class="border-b-2 border-green-800">
                        <div class="max-w-2xl px-4 py-2 bg-white rounded-lg shadow-md mx-auto my-2">
                            <div class="mt-2">
                                <h2 class="text-md font-bold text-gray-700 hover:text-gray-600 hover:underline"
                                    tabindex="0">権限の削除</h2>
                    ...
                    <!-- approval-create -->
                    <div id="approval-create" class="border-b-2 border-green-800">
                        <div class="max-w-2xl px-4 py-2 bg-white rounded-lg shadow-md mx-auto my-2">
                            <div class="mt-2">
                                <h2 class="text-md font-bold text-gray-700 hover:text-gray-600 hover:underline"
                                    tabindex="0">権限の追加</h2>
