...
class ApprovalSeeder extends Seeder
{
    ...
    public function run()
    {
        $param = [
            ...
            ['user_id' => 48, 'factory_id' => 1, 'department_id' => 7, 'group_id' => 1, 'approval_id' => 2], # 366 一関工場総務部 上長
            ...
            ['user_id' => 2, 'factory_id' => 1, 'department_id' => 2, 'group_id' => 1, 'approval_id' => 3], # 618 営業GL (テストメンバー506)
            ...
            ['user_id' => 85, 'factory_id' => 2, 'department_id' => 10, 'group_id' => 15, 'approval_id' => 3], # 325 溶接3GL (テストメンバー407)
            ['user_id' => 86, 'factory_id' => 2, 'department_id' => 10, 'group_id' => 15, 'approval_id' => 3], # 450 溶接3GL (テストメンバー407)
            ...
            ['user_id' => 119, 'factory_id' => 2, 'department_id' => 3, 'group_id' => 2, 'approval_id' => 3], # 400 プレスG (テストメンバー92)
            ['user_id' => 119, 'factory_id' => 2, 'department_id' => 3, 'group_id' => 19, 'approval_id' => 3], # 400 金型保全G (テストメンバー6)
        ];
